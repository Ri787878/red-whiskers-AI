...
def easyBot(ROWS, COLS, CELL_SIZE, start_pos, coordinates):
	SCREEN = initPygame(ROWS, COLS, CELL_SIZE, "Easy Bot Pathfinding")
...
def start(gameMap, start_pos, moves):
    ...
    # Determine next move (this is a placeholder; logic can be adjusted)
...
def mediumBot(ROWS, COLS, CELL_SIZE, startPos, coordinates):
	SCREEN = initPygame(ROWS, COLS, CELL_SIZE, "BFS Pathfinding with Search Spread")
	gameMap = create_map_from_coordinates(coordinates, (ROWS, COLS))
	bfs_path = []
	visited = set()
